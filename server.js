...
io.on('connection', function (socket) {
  ...
  */
  ...
  socket.on('swimming', function (msg) {
    ...
    for (var i = 1; i <= 8; i++) {
      swimming['pos' + i + 'name'] = swimming['lane' + (swimming.order).charAt(i - 1) + 'name']
      swimming['pos' + i + 'team'] = swimming['lane' + (swimming.order).charAt(i - 1) + 'team']
